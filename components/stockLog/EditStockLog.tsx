...
// export function EditStockLog({
//     item,
//     open,
//     onOpenChange,
//     onEditSuccess,
//     onDeleteSuccess, }: { item: { item: StockLog}, open: boolean, onOpenChange: (open: boolean) => void, showTrigger?: boolean, onEditSuccess?: (updated: InventoryRow) => void, onDeleteSuccess?: (deleteId: string) => void }) {
